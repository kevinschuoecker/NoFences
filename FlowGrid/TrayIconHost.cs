...
namespace FlowGrid
{
    ...
    public class TrayIconHost : IDisposable
    {
        ...
        private static void ExportLayout()
        {
            ...
            {
                Filter = "FlowGrid layout (*.xml)|*.xml",
                FileName = "FlowGrid-layout.xml",
            ...
            })
            {
                ...
                {
                    MessageBox.Show("Export failed: " + ex.Message, "FlowGrid", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private static void ImportLayout()
        {
            ...
            })
            {
                ...
                {
                    MessageBox.Show("Import failed: " + ex.Message, "FlowGrid", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
